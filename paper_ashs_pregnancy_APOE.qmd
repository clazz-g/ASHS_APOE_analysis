...
Parity showed a weak association with YKL-40 in APOE4 carriers but this association was not significant (β= `r tidy(yk402)$estimate[2]`, SE = `r tidy(yk402)$std.error[2]`, p= `r tidy(yk402)$p.value[2]`).
